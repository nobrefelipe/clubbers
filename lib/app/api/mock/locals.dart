...
final List<Local> locals = [
  ...
  Local(
    ...
    followers: ['1', "2", "3"],
    type: [place_types.balada, place_types.barzinho],
    events: [],
    profilePicture:
  ...
  Local(
    id: "5",
    name: 'Pedreira Guarapari',
    phone: "27 99948833",
    email: "contato@pedreiraguarapari.com.br",
    address: "Rua. Mestre da Praia Grande, 9 - Guarapari",
    followers: ["1", "2", "3"],
    type: [place_types.balada, place_types.barzinho],
    events: [],
    profilePicture:
