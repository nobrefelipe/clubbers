...
/*
  CUSTOM PAGE VIEW
  PageView widget looks cool but when we set viewportFraction, the view gets center aligned.
  
  This is a custom page view compknent that will have this feature.
  ssee: https://github.com/flutter/flutter/issues/52014
...
class _CustomPageViewState extends State<CustomPageView> {
  ...
  Widget build(BuildContext context) {
    ...
    ).applyTo(widget.pageSnapping ? _kPagePhysics.applyTo(widget.physics) : widget.physics);
